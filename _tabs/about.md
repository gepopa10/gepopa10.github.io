...
## Changing the manufacturing industry at [Omnirobotic](https://omnirobotic.com/)
...
I worked on a ground robot responsible of delivering goods in a hospital.
...
I also designed the robotic system by choosing sensors such as sonars, wheels encoder and radar for improved localization and obstacle avoidance. I integrated them with the [ROS Navigation Stack](https://github.com/ros-planning/navigation).
...
## Changing people's lives at the Intelligent Systems and Mechatronics Lab
...
I learned how to setup a realistic simulation in Gazebo including the estimation of drag and bouncing coefficients of the ping pong ball.
...
Furthermore, to find the right trajectory to follow by the controller, a minimum snap trajectory planner was implemented with constraints on the estimated hitting 3D position of the ping pong ball.
...
I developed a self-balancing robot using stepper motors and a Raspberry Pi.

I chose the components, 3D printed the parts and soldered the electrical components such as the motor controller.

<p>&#11088; <strong>Main challenge: </strong> Tune a controller for low frequency adjustment of a self-balancing robot.</p>
...
Here is a picture of me on top of Gingilos mountain, Crete, Greece in 2024.
